...
$oAuth = [
    'Google' => [
        ...
        'ClientID' => 'Profile|IM|Google|ClientID',
        'ClientSecret' => 'Profile|IM|Google|ClientSecret',
        'RedirectURL' => 'https://demo.inter-mediator.com/IMTesting_OAuth/OAuthCatcher.php',
    ],
    'Facebook' => [
        'AuthButton' => 'Facebook',
        'ClientID' => 'Profile|IM|Facebook|ClientID',
        'ClientSecret' => 'Profile|IM|Facebook|ClientSecret',
        'RedirectURL' => 'https://demo.inter-mediator.com/IMTesting_OAuth/OAuthCatcher.php',
    ],
];
